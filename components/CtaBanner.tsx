...
export default function CtaBanner() {
  return (
    <section className="px-6 md:px-12 lg:px-16 py-36 md:py-48 max-w-[1720px] mx-auto border-t border-slate-200/80">
      <div className="max-w-5xl space-y-10 home-reveal">
        ...
        <div className="inline-flex items-center gap-3 text-[11px] font-mono font-bold uppercase tracking-[0.16em] text-slate-700 border border-slate-200 rounded-full px-5 py-2.5 bg-white shadow-sm">
          ...
          <span className="text-[#d97706] font-extrabold">LIMITED 2026 ENGAGEMENT SLOTS</span>
        </div>
        ...
        <h2 className="text-[clamp(40px,5.8vw,80px)] font-extrabold leading-[1.04] tracking-tight text-[#0a0e1a]">
          ...
          <span className="font-serif italic font-normal text-[#0055ff]">
            can&apos;t risk.
          </span>
        </h2>
        ...
        <div className="flex flex-wrap items-center gap-4 pt-4">
          <Link
            href="/contact-us"
            className="inline-flex items-center gap-2.5 bg-[#0a0e1a] hover:bg-[#0055ff] text-white font-bold text-[14px] px-9 py-4 rounded-full transition-all duration-300 shadow-[0_8px_24px_rgba(10,14,26,0.12)] hover:shadow-xl group"
          >
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 border border-slate-300 hover:border-slate-900 bg-white text-slate-900 font-bold text-[14px] px-8 py-4 rounded-full transition-all shadow-sm hover:bg-slate-50"
          >
