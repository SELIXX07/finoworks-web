  ...
  return (
    <section className="px-6 md:px-12 lg:px-16 py-32 md:py-44 max-w-[1720px] mx-auto">
      ...
      <div className="max-w-[1240px] space-y-12">
        ...
        <p className="text-[clamp(30px,4.4vw,60px)] font-normal leading-[1.14] text-white tracking-tight home-reveal">
          ...
          <span className="font-serif italic font-normal text-[#00e5ff] underline decoration-[#00e5ff]/40 underline-offset-[12px] hover-highlight">
        ...
        <div className="h-px bg-blue-500/20 w-full home-reveal" />

        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start home-reveal">
          <div className="md:col-span-4 font-mono text-xs uppercase font-bold tracking-[0.16em] text-[#00e5ff]">
            [ THE FINOWORKS METHODOLOGY ]
          </div>
          <div className="md:col-span-8 space-y-4">
            <p className="text-[clamp(15px,1.3vw,19px)] text-slate-300 leading-relaxed font-normal">
